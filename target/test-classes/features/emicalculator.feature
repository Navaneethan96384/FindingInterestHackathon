...
Feature: Calculate Car Loan Emi
  ...
  Scenario Outline: Calculating car loan emi with various inputs
    Given the user is on the emicalculator page using <browser>
    When the user clicks on the car loan tab
    When the user enters the car loan <amount>
    When the user enters the loan interest <rate>
    When the user enters the loan tenure <duration> <period>
